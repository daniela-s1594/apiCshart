...
namespace App_API_DMV.Data
{
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            try
            {
                strCadenaCnx = "workstation id=BDDMV2503680.mssql.somee.com;packet size=4096;user id=dani680_SQLLogin_1;pwd=z8lbc4eur6;data source=BDDMV2503680.mssql.somee.com;persist security info=False;initial catalog=BDDMV2503680";
